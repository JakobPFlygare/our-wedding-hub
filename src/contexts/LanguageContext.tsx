...
const translations: Record<Language, Translations> = {
  en: {
    ...
    rsvp: {
      ...
      plusOneNote: 'We understand it\'s a long trip, so please feel free to bring a companion! Just include both names in the RSVP below.',
  ...
  sv: {
    ...
    rsvp: {
      ...
      plusOneNote: 'Vi förstår att det är en lång resa, så ta gärna med en kompis/partner! Ange bara båda namnen i OSA-formuläret nedan.',
