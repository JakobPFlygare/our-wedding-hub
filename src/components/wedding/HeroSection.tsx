  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 md:px-6 py-16 md:py-20">
        ...
        <div className="absolute inset-0 bg-charcoal/30 backdrop-blur-[2px] rounded-3xl -mx-2 md:-mx-4" />
        
        <div className="relative">
          <h1 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-cream drop-shadow-lg mb-4 opacity-0 animate-fade-in-up" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.5)' }}>
            Pau & Jakob
          </h1>
          ...
          <div className="flex items-center justify-center gap-2 md:gap-4 mb-6 md:mb-8 opacity-0 animate-fade-in-up animation-delay-400">
            ...
            <p className="font-body text-lg md:text-xl lg:text-2xl text-cream italic" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>
              {t.hero.gettingMarried}
            </p>
            <div className="h-px w-8 md:w-16 bg-marigold/80" />
          </div>
          
          <p className="font-display text-xl md:text-2xl lg:text-3xl text-cream mb-2 opacity-0 animate-fade-in-up animation-delay-600" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>
            January 9, 2027
          </p>
          
          <p className="font-body text-base md:text-lg text-cream mb-8 md:mb-10 opacity-0 animate-fade-in-up animation-delay-600" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.5)' }}>
          ...
          <div className="opacity-0 animate-fade-in-up animation-delay-800">
            ...
            <p className="inline-block font-sans text-sm text-cream bg-charcoal/60 backdrop-blur-sm px-4 py-1.5 rounded-full mt-4">
              {t.hero.rsvpDeadline}
            </p>
          </div>
        </div>
